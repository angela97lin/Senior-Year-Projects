...
var move_element = function(text){
    ...
    //super duper important to do, for otherwise
    //the event will remain on the page;
    //will not be eaten by the garbage collector :(
    //and will cause memory to be gobbled up...
